            ...
            <div className="reg-side col-lg-6 d-flex align-items-center">
              <div className="px-3 py-4 p-md-5 mx-md 4">
                ...
                <p className="small mb-0">
                  Although there are related applications available on the market which may allow users to create packing checklists, help with budgeting their trip, and create an itinerary, there still doesn’t exist a service that seamlessly integrates all of these functionalities into one intuitive, easy-to-use application. 
                  With Trip++, you can easily plan your trip and save on the go. Trip++ is your ultimate smart trip planner which will save you time and stress.
                </p>
              </div>
            </div>
          </div>
